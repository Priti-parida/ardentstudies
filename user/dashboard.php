...
<?php 
$rtp =mysqli_query($conn ,"SELECT ID from tbladmapplications where UserID='$uid'");
$row=mysqli_fetch_array($rtp);
if($row>0){
$ret=mysqli_query($conn,"select AdminStatus from  tbladmapplications join tbldocument on tbldocument.UserID=tbladmapplications.UserID where tbldocument.UserID='$stuid' and  tbladmapplications.AdminStatus='1'");
